...
public final class APIVerify {
    ...
    public static String getVerifyString() {
        ...
        return MD5.get32MD5Str(MD5.get32MD5Str(BuildConfig.APPLICATION_ID) + MD5.get32MD5Str(BuildConfig.VERSION_NAME) + AES.encryptByBase64(BuildConfig.APPLICATION_ID));
    }
